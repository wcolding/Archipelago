...
wattos_shop_table = {
    "Watto's Shop - Traction Upgrade 1":     SWRLocationData(0, 0),
    "Watto's Shop - Traction Upgrade 2":     SWRLocationData(1, 2),
    "Watto's Shop - Traction Upgrade 3":     SWRLocationData(2, 6),
    "Watto's Shop - Traction Upgrade 4":     SWRLocationData(3, 10),
    "Watto's Shop - Traction Upgrade 5":     SWRLocationData(4, 14),
    
    "Watto's Shop - Turning Upgrade 1":      SWRLocationData(5, 0),
    "Watto's Shop - Turning Upgrade 2":      SWRLocationData(6, 2),
    "Watto's Shop - Turning Upgrade 3":      SWRLocationData(7, 6),
    "Watto's Shop - Turning Upgrade 4":      SWRLocationData(8, 12),
    "Watto's Shop - Turning Upgrade 5":      SWRLocationData(9, 16),
    
    "Watto's Shop - Acceleration Upgrade 1": SWRLocationData(10, 0),
    "Watto's Shop - Acceleration Upgrade 2": SWRLocationData(11, 4),
    "Watto's Shop - Acceleration Upgrade 3": SWRLocationData(12, 8),
    "Watto's Shop - Acceleration Upgrade 4": SWRLocationData(13, 10),
    "Watto's Shop - Acceleration Upgrade 5": SWRLocationData(14, 12),
    
    "Watto's Shop - Top Speed Upgrade 1":    SWRLocationData(15, 0),
    "Watto's Shop - Top Speed Upgrade 2":    SWRLocationData(16, 2),
    "Watto's Shop - Top Speed Upgrade 3":    SWRLocationData(17, 8),
    "Watto's Shop - Top Speed Upgrade 4":    SWRLocationData(18, 12),
    "Watto's Shop - Top Speed Upgrade 5":    SWRLocationData(19, 16),
    
    "Watto's Shop - Air Brake Upgrade 1":    SWRLocationData(20, 0),
    "Watto's Shop - Air Brake Upgrade 2":    SWRLocationData(21, 4),
    "Watto's Shop - Air Brake Upgrade 3":    SWRLocationData(22, 6),
    "Watto's Shop - Air Brake Upgrade 4":    SWRLocationData(23, 10),
    "Watto's Shop - Air Brake Upgrade 5":    SWRLocationData(24, 14),
    
    "Watto's Shop - Cooling Upgrade 1":      SWRLocationData(25, 0),
    "Watto's Shop - Cooling Upgrade 2":      SWRLocationData(26, 6),
    "Watto's Shop - Cooling Upgrade 3":      SWRLocationData(27, 8),
    "Watto's Shop - Cooling Upgrade 4":      SWRLocationData(28, 10),
    "Watto's Shop - Cooling Upgrade 5":      SWRLocationData(29, 14),
    
    "Watto's Shop - Repair Upgrade 1":       SWRLocationData(30, 0),
    "Watto's Shop - Repair Upgrade 2":       SWRLocationData(31, 2),
    "Watto's Shop - Repair Upgrade 3":       SWRLocationData(32, 4),
    "Watto's Shop - Repair Upgrade 4":       SWRLocationData(33, 8),
    "Watto's Shop - Repair Upgrade 5":       SWRLocationData(34, 12),
}
